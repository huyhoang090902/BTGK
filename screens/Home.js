  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Appbar.Header>
        ...
        />
        <Button textColor='black' buttonColor='purple' mode='contained' onPress={addJob} disabled={!isValid}>ADD</Button>
      </Appbar.Header>
      <FlatList
        style={{ flex: 1 }}
        data={jobs}
      ...
      <View style={styles.bottomContainer}>
        <Button textColor='black' buttonColor='purple' icon="logout" mode="contained" onPress={handleLogout}>
          Logout
        </Button>
      </View>
    </View>
